...
export function SpotlightCard({
  ...
  const getSpotlightBackground = (
    ...
    return `radial-gradient(${size}px ${blur ? "ellipse" : "circle"} at ${pos.x
      }px ${pos.y}px, 
        ...
        style={
          {
            ...
            ["--spotlight-color" as string]: `color-mix(in srgb, var(--gradient-color, ${currentGradientColor}), transparent ${(1 - spotlightOpacity) * 100
              }%)`,
          ...
          style={
            {
              ...
              ["--spotlight-color" as string]: `color-mix(in srgb, var(--gradient-color, ${currentGradientColor}), transparent ${(1 - spotlightOpacity * 0.8) * 100
                }%)`,
            } as React.CSSProperties
          }
        />
